        ...
        <Col className="d-flex align-items-center">
          <div>
            ...
            <p>  
                ...
                the recipe wasn't really presented in an easy to read manner. Finally; I got so frustrated and created this website, <a href={window.location.origin}>{urlText}</a>.
            </p>
            <p>
